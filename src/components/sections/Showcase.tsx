...
export default function Showcase() {
  ...
  return (
    <section id="showcase" className="bg-background py-20 md:py-28">
      <div className="container">
        <h2 className="heading-display text-4xl md:text-6xl mb-8">Showcase</h2>
        <p className="text-brand-red/70 max-w-2xl mb-10">A taste of our craft. Subtle reveals on scroll and gentle zoom on hover, powered by GSAP.</p>
