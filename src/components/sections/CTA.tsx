export default function CTA() {
  ...
  <p className="mt-4 text-brand-red/85 max-w-2xl mx-auto">From farm to cup, our coffees are curated for flavor and climate impact. Request samples or start a wholesale conversation.</p>
